...
const I18N = {
  en: {
    ...
    'action.pass.title': 'PASS',        'action.pass.sub': 'to feet',
    'action.carry.title': 'CARRY',      'action.carry.sub': 'create angle',
    'action.bounce.title': 'BOUNCE',    'action.bounce.sub': 'wall pass',
    'action.thirdMan.title': '3RD MAN', 'action.thirdMan.sub': 'blind-side',
    'action.switchPlay.title': 'SWITCH','action.switchPlay.sub': 'space drop',
    ...
    'space.noSpace': 'NO SPACE',
    'space.contested': 'CONTESTED',
    'space.trap': 'TRAP SPACE',
    'space.runner': 'runner attacks',
    'space.longPass': 'LONG TO SPACE',
    'space.leadPass': 'lead pass',

    'fail.limit': 'Exceeded allowable actions',
    'fail.intercept': 'Pass route intercepted by opponent block',
    'fail.interceptBy': 'Intercepted because of {reason}',
    ...
    'fail.pressureMax': 'Press collapsed before the escape',
  ...
  ko: {
    ...
    'action.pass.title': '발밑',     'action.pass.sub': '직접 패스',
    'action.carry.title': '볼 운반',      'action.carry.sub': '각도 만들기',
    'action.bounce.title': '원투', 'action.bounce.sub': '되받기',
    'action.thirdMan.title': '써드맨','action.thirdMan.sub': '뒷공간 침투',
    'action.switchPlay.title': '전환','action.switchPlay.sub': '공간으로',
    'action.dropPivot.title': 'DM 하강','action.dropPivot.sub': '후방 지원',
    ...
    'reason.receiverPressure': '마크',
    'reason.trapZone': '트랩',
    'reason.lineBreak': '라인 돌파',
    'reason.notIsolated': '반대편 고립 부족',
    'reason.bodyAngle': '몸 방향',
    'reason.marked': '마킹',
  ...
  ja: {
    ...
    'action.pass.title': 'パス',     'action.pass.sub': '足元へ',
    'action.carry.title': '\u904B\u3076',      'action.carry.sub': '\u89D2\u5EA6\u4F5C\u6210',
    'action.bounce.title': 'ワンツー','action.bounce.sub': '壁パス',
    'action.thirdMan.title': '3人目', 'action.thirdMan.sub': 'ブラインドサイド',
    'action.switchPlay.title': '展開','action.switchPlay.sub': '空間へ',
    ...
    'reason.notIsolated': '孤立せず',
    'reason.bodyAngle': '体の向き',
    'reason.marked': 'マーク',
